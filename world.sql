...
select * from country where `Continent` like 'North America' and name like 'a%';

select * from country where `Population`>=1000000000;

select * from CountryLanguage where `Language` like 'Spanish' and `IsOfficial` like 'T';

select * from city where `CountryCode` like 'USA' and `District` like 'Colorado' and `Population`<=200000;

select * from countrylanguage where `CountryCode` like 'CZE' and `IsOfficial` like 'F';
